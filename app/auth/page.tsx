          ...
          {isLogin ? (
            <>
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-700 bg-slate-900/60 p-3 text-white placeholder:text-slate-500 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
              />
              ...
              <input
                ...
                className="mt-3 w-full rounded-lg border border-slate-700 bg-slate-900/60 p-3 text-white placeholder:text-slate-500 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
              />
